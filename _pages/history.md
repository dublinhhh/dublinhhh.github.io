...
GoToTheHash has a very nice [Interhash History page](https://gotothehash.net/history/interhash.html).  From that page there's copy of a [1978 Washington Post report on the first Interhash](https://gotothehash.net/history/Interhash/washpost78.pdf).
...
>
> <figure>
>   <img src="{{ 'assets/images/original-hash-house-kuala-lumpur.jpg' | relative_url }}" alt="Original Hash House" style="width:75%">
